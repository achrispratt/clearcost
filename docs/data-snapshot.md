...
_Generated: 2026-03-01T20:43:51.904Z_
...
| Metric | Value | Status |
|--------|------:|-------|
| Supabase charges (live) | 12,574,162 | ⚠ 95.9% of target |
| DuckDB target (filtered) | 13,115,274 | — |
| Gap | 541,112 | NJ + PA missing |
...
|----------|-------|--------------|
| 🔴 | NJ charges missing — reimport needed | 182,010 |
| 🔴 | PA charges missing — reimport needed | 359,096 |
...
|-------|---------------:|--------|
| 1-5: Current (1,010 codes, outpatient) | 13,115,274 | ✅ 95.9% live |
| 6: All outpatient codes | +210,362,033 | 📋 Planned |
