...
_Generated: 2026-03-02T17:41:54.631Z_
...
| Metric                      |         Value | Status                     |
| --------------------------- | ------------: | -------------------------- |
| Supabase charges (live)     |    13,115,268 | ⚠ 100.0% of target         |
...
| -------------------------------------- | -------------: | --------------- |
| 1-5: Current (1,010 codes, outpatient) |     13,115,274 | ✅ 100.0% live  |
...
Supabase (current state)
  ...
  Gap: 6 charges not yet in Supabase
...
| PA      |       243 |     359,096 |          243 |         232 |          11 |    359,096 | ✓     |
